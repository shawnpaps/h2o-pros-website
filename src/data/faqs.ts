...
export const faqs: Faq[] = [
  {
    ...
    answer:
      'Yes — for emergencies, a real person answers around the clock, every day of the year. Regular office hours are Monday through Friday, 8am to 5pm, but burst pipes don’t keep business hours and neither do we.',
  },
  {
